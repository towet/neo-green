...
function App() {
  ...
  const RoiNotification = () => {
    ...
    return (
      <div 
        className="fixed top-4 right-4 bg-gradient-to-r from-cyan-600 to-indigo-600 text-white p-4 rounded-lg shadow-lg transform transition-all duration-500 ease-in-out animate-fade-in z-50 max-w-md"
        style={{
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-cyan-100">Our ROI Calculator feature is under development. Stay tuned for updates!</p>
          </div>
          <button 
    ...
    <div className="bg-gray-900 min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-gradient-to-b from-gray-900/90 to-gray-900/0 backdrop-blur-sm">
        ...
        >
          ...
          {/* Menu Container */}
          <div className="relative z-10 bg-gradient-to-b from-gray-900 to-gray-800 min-h-[calc(100vh-80px)] flex flex-col items-center justify-center space-y-10 p-6">
            <div className="w-full max-w-sm space-y-10">
              <a 
                href="#services" 
                onClick={() => setIsMenuOpen(false)}
                className="block w-full text-center py-3 text-xl font-medium text-gray-100 hover:text-cyan-400 transition-all duration-300 border-b border-gray-700/50 hover:border-cyan-400/30"
              >
                Services
              </a>
              <a 
              ...
              <button className="w-full px-8 py-4 rounded-lg bg-gradient-to-r from-cyan-500 to-cyan-400 text-white font-medium text-lg hover:from-cyan-400 hover:to-cyan-300 transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-400/30">
                Contact Us
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mt-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button 
                className="px-8 py-4 bg-transparent border-2 border-cyan-500/50 text-cyan-400 rounded-full hover:border-cyan-400 hover:text-cyan-300 transition-all duration-300 text-lg font-semibold flex items-center justify-center group"
      ...
      {/* Quick ROI Calculator Modal */}
      <div className={`fixed inset-0 bg-gray-900 backdrop-blur-sm z-50 transition-all duration-300 ${
        showCalculator ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
      }`}>
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 max-w-lg w-full border border-cyan-500/20">
            <div className="space-y-6">
              <div>
                ...
                <input 
                  type="number" 
                  className="w-full bg-gray-900/50 border border-gray-700 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500"
                  placeholder="e.g., 50"
                />
              </div>
              <div>
              ...
              <button className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg hover:from-cyan-400 hover:to-cyan-500 transition-all duration-300 font-semibold">
